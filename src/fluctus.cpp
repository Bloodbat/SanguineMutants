...
static const std::vector<FluctusModeInfo> modeList{
...
static const std::vector<FluctusModeDisplay> modeDisplays{
...
static const std::vector<FluctusModeDisplay> modeTooltips{
	{"Freeze",  "Position",                    "Density",              "Size",                    "Texture",        "Pitch",          "Trigger",   "Blend",             "Spread",                    "Feedback",         "Reverb"},
	{"Stutter", "Scrub",                       "Diffusion",            "Overlap",                 "LP/HP",          "Pitch",          "Time",      "Blend",             "Spread",                    "Feedback",         "Reverb"},
...
struct FluctusWidget : ModuleWidget {
	FluctusWidget(Fluctus* module) {
		...
		addInput(createInputCentered<BananutPurple>(mm2px(Vec(7.677, 25.607)), module, Fluctus::INPUT_FREEZE));
		CKD6* freezeButton = createParamCentered<CKD6>(mm2px(Vec(21.529, 25.607)), module, Fluctus::PARAM_FREEZE);
		freezeButton->latch = true;
		freezeButton->momentary = false;
		addParam(freezeButton);
		addChild(createLightCentered<CKD6Light<BlueLight>>(mm2px(Vec(21.529, 25.607)), module, Fluctus::LIGHT_FREEZE));

		addChild(createLightCentered<MediumLight<GreenRedLight>>(mm2px(Vec(79.173, 12.851)), module, Fluctus::LIGHT_BLEND));
		addChild(createLightCentered<MediumLight<GreenRedLight>>(mm2px(Vec(85.911, 12.851)), module, Fluctus::LIGHT_SPREAD));
		addChild(createLightCentered<MediumLight<GreenRedLight>>(mm2px(Vec(92.649, 12.851)), module, Fluctus::LIGHT_FEEDBACK));
		addChild(createLightCentered<MediumLight<GreenRedLight>>(mm2px(Vec(99.386, 12.851)), module, Fluctus::LIGHT_REVERB));

		addParam(createParamCentered<TL1105>(mm2px(Vec(107.606, 12.851)), module, Fluctus::PARAM_LEDS_MODE));
		...
		addParam(createParamCentered<Sanguine1PGrayCap>(mm2px(Vec(129.805, 25.227)), module, Fluctus::PARAM_MODE));

		addParam(createLightParamCentered<VCVLightSlider<GreenRedLight>>(mm2px(Vec(11.763, 50.173)), module, Fluctus::PARAM_POSITION, Fluctus::LIGHT_POSITION_CV));
		...
		addInput(createInputCentered<BananutBlack>(mm2px(Vec(11.763, 76.776)), module, Fluctus::INPUT_POSITION));

		addParam(createLightParamCentered<VCVLightSlider<GreenRedLight>>(mm2px(Vec(29.722, 50.173)), module, Fluctus::PARAM_DENSITY, Fluctus::LIGHT_DENSITY_CV));
		...
		addInput(createInputCentered<BananutBlack>(mm2px(Vec(29.722, 76.776)), module, Fluctus::INPUT_DENSITY));

		addParam(createLightParamCentered<VCVLightSlider<GreenRedLight>>(mm2px(Vec(47.682, 50.173)), module, Fluctus::PARAM_SIZE, Fluctus::LIGHT_SIZE_CV));
		...
		addInput(createInputCentered<BananutBlack>(mm2px(Vec(47.682, 76.776)), module, Fluctus::INPUT_SIZE));

		addParam(createLightParamCentered<VCVLightSlider<GreenRedLight>>(mm2px(Vec(65.644, 50.173)), module, Fluctus::PARAM_TEXTURE, Fluctus::LIGHT_TEXTURE_CV));
		...
		addInput(createInputCentered<BananutBlack>(mm2px(Vec(65.644, 76.776)), module, Fluctus::INPUT_TEXTURE));

		addParam(createParamCentered<Sanguine1PRed>(mm2px(Vec(105.638, 41.169)), module, Fluctus::PARAM_PITCH));
		...
		addInput(createInputCentered<BananutPurple>(mm2px(Vec(105.638, 59.887)), module, Fluctus::INPUT_PITCH));

		addParam(createParamCentered<Sanguine1PGreen>(mm2px(Vec(86.118, 41.169)), module, Fluctus::PARAM_BLEND));
		...
		addInput(createInputCentered<BananutPurple>(mm2px(Vec(86.118, 59.887)), module, Fluctus::INPUT_BLEND));
		...
		addInput(createInputCentered<BananutPurple>(mm2px(Vec(125.214, 59.887)), module, Fluctus::INPUT_TRIGGER));

		addInput(createInputCentered<BananutPurple>(mm2px(Vec(86.118, 78.013)), module, Fluctus::INPUT_SPREAD));
		...
		addParam(createParamCentered<Sanguine1PBlue>(mm2px(Vec(86.118, 96.727)), module, Fluctus::PARAM_SPREAD));

		addInput(createInputCentered<BananutPurple>(mm2px(Vec(105.638, 78.013)), module, Fluctus::INPUT_FEEDBACK));
		...
		addParam(createParamCentered<Sanguine1PPurple>(mm2px(Vec(105.638, 96.727)), module, Fluctus::PARAM_FEEDBACK));

		addInput(createInputCentered<BananutPurple>(mm2px(Vec(125.214, 78.013)), module, Fluctus::INPUT_REVERB));
		...
		addParam(createParamCentered<Sanguine1PYellow>(mm2px(Vec(125.214, 96.727)), module, Fluctus::PARAM_REVERB));

		addParam(createParamCentered<Rogan1PWhite>(mm2px(Vec(14.603, 97.272)), module, Fluctus::PARAM_IN_GAIN));

		addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<GreenLight>>>(mm2px(Vec(31.438, 97.272)), module, Fluctus::PARAM_HI_FI, Fluctus::LIGHT_HI_FI));
		addParam(createLightParamCentered<VCVLightLatch<MediumSimpleLight<RedLight>>>(mm2px(Vec(56.63, 97.272)), module, Fluctus::PARAM_STEREO, Fluctus::LIGHT_STEREO));

		addInput(createInputCentered<BananutGreen>(mm2px(Vec(7.677, 116.972)), module, Fluctus::INPUT_LEFT));
		addInput(createInputCentered<BananutGreen>(mm2px(Vec(21.529, 116.972)), module, Fluctus::INPUT_RIGHT));
		...
		addOutput(createOutputCentered<BananutGreen>(mm2px(Vec(115.161, 116.972)), module, Fluctus::OUTPUT_LEFT));
		addOutput(createOutputCentered<BananutGreen>(mm2px(Vec(129.013, 116.972)), module, Fluctus::OUTPUT_RIGHT));
