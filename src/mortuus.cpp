...
struct MortuusWidget : ModuleWidget {
	MortuusWidget(Mortuus* module) {
		...
		SanguinePanel* panel = new SanguinePanel(pluginInstance, "res/backplate_22hp_red.svg", "res/mortuus_faceplate.svg");
		setPanel(panel);
		...
		addChild(createLightCentered<MediumLight<RedLight>>(millimetersToPixelsVec(16.113, 27.965), module, Mortuus::LIGHT_CHANNEL1));
		addChild(createLightCentered<MediumLight<RedLight>>(millimetersToPixelsVec(16.113, 40.557), module, Mortuus::LIGHT_CHANNEL2));
		...
		addInput(createInputCentered<BananutGreen>(millimetersToPixelsVec(10.375, 84.976), module, Mortuus::GATE_1_INPUT));
		addInput(createInputCentered<BananutGreen>(millimetersToPixelsVec(10.375, 100.593), module, Mortuus::GATE_2_INPUT));

		addOutput(createOutputCentered<BananutRed>(millimetersToPixelsVec(101.388, 100.846), module, Mortuus::OUT_1_OUTPUT));
		addOutput(createOutputCentered<BananutRed>(millimetersToPixelsVec(101.388, 116.989), module, Mortuus::OUT_2_OUTPUT));
