...
namespace marmora {
    ...
    static const RGBLightColor paletteClockSources[kMaxClockSourceTypes]{
    ...
    static const std::vector<std::string> tModeLabels = {
    ...
    static const std::vector<std::string> tRangeLabels = {
        "1/4x",
        "1x",
        "4x"
    };

    static const std::vector<std::string> xModeLabels = {
        "Identical",
        "Bump",
        "Tilt"
    };

    static const std::vector<std::string> xRangeLabels = {
        "Narrow (0V - 2V)",
        "Positive (0V - +5V)",
        "Full (-5V - +5V)"
    };

    static const std::vector<std::string> scaleLabels = {
        "Major",
        "Minor",
        "Pentatonic",
        "Gamelan (Pelog)",
    ...
    static const std::vector<std::string> internalClockLabels = {
        "t₁ → X₁, T₂ → X₂, T₃ → X₃",
        "t₁ → X₁, X₂, X₃",
        "t₂ → X₁, X₂, X₃",
        "t₃ → X₁, X₂, X₃",
    ...
    static const std::vector<std::string> lockLabels = {
        "Unlocked",
        "Locked"
    };
